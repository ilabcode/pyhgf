...
\begingroup%
  ...
  \begin{picture}(1,0.70675867)%
    ...
    \put(0.2571404,0.6085509){\color[rgb]{0.62352941,0,0.52941176}\makebox(0,0)[b]{\smash{$\alpha_{i-1,i}^2$}}}%
    \put(0.56974797,0.60855047){\color[rgb]{0.62352941,0,0.52941176}\makebox(0,0)[lb]{\smash{$\alpha_{i,i+1}^2$}}}%
    \put(0.40154567,0.50407458){\color[rgb]{0.62352941,0,0.52941176}\makebox(0,0)[b]{\smash{$\alpha_{i-1,i}^2$}}}%
    \put(0.71415312,0.50502436){\color[rgb]{0.62352941,0,0.52941176}\makebox(0,0)[lb]{\smash{$\alpha_{i,i+1}^2$}}}%
  \end{picture}%
\endgroup%
