...
%% Accompanies image file 'vope_all.eps' (pdf, eps, ps)
%%
...
\begingroup%
  ...
  \begin{picture}(1,0.70675867)%
    \put(0,0){\includegraphics[width=\unitlength]{vope_all.eps}}%
    ...
    \put(0.47753692,0.47107002){\color[rgb]{0,0,0}\makebox(0,0)[b]{\smash{\w{$\check{\mu}_i$}}}}%
    \put(0.55731885,0.53280601){\color[rgb]{0,0,0}\makebox(0,0)[b]{\smash{$\hat{\check{\pi}}_i$}}}%
    \put(0.55443982,0.46988273){\color[rgb]{0,0,0}\makebox(0,0)[b]{\smash{$\hat{\check{\mu}}_i$}}}%
    \put(0.51410156,0.38355672){\color[rgb]{1,1,1}\makebox(0,0)[b]{\smash{\w{$\check{\delta}_i$}}}}%
    \put(0.26452033,0.38691282){\color[rgb]{1,1,1}\makebox(0,0)[b]{\smash{\w{$\Delta_i$}}}}%
    ...
    \put(0.44726404,0.60950115){\color[rgb]{0.62352941,0,0.52941176}\makebox(0,0)[lb]{\smash{$\alpha_{i,i+1}^2$}}}%
    \put(0.50706188,0.68073501){\color[rgb]{0,0.48235294,0.61568627}\makebox(0,0)[lb]{\smash{$\alpha_{i,i+1}^2$}}}%
    \put(0.41507173,0.50181736){\color[rgb]{0.80392157,0.52156863,0.02352941}\makebox(0,0)[lb]{\smash{$\kappa_{i}$}}}%
    ...
    \put(0.37440631,0.42560073){\color[rgb]{0.43529412,0,0.37254902}\makebox(0,0)[lb]{\smash{$\omega_{i}$}}}%
    \put(0.58127124,0.02348388){\color[rgb]{0,0.78431373,1}\makebox(0,0)[b]{\smash{$\alpha_{i,i+1}$}}}%
  \end{picture}%
\endgroup%
