...
![graph_networks](../images/graph_network.svg)
...
2. a named tuple `node_structure` that encodes the [adjacency list](https://en.wikipedia.org/wiki/Adjacency_list) (see {ref}`pyhgf.typing.Indexes`).
