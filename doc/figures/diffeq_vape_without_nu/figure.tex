...
%% Accompanies image file 'vape_without_nu.eps' (pdf, eps, ps)
%%
...
\begingroup%
  ...
  \begin{picture}(1,0.69284606)%
    \put(0,0){\includegraphics[width=\unitlength]{vape_without_nu.eps}}%
    ...
    \put(0.61317851,0.03068013){\color[rgb]{0,0.78431373,1}\makebox(0,0)[b]{\smash{\footnotesize $\alpha_{i,i+1}$}}}%
    ...
    \put(0.25478946,0.57030437){\color[rgb]{0.62352941,0,0.52941176}\makebox(0,0)[lb]{\smash{\tiny $\exp(\omega_i)$}}}%
