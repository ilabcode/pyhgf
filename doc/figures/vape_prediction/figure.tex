...
%% Accompanies image file 'vape_prediction.eps' (pdf, eps, ps)
%%
...
\begingroup%
  ...
  \begin{picture}(1,0.70675867)%
    ...
    \put(0,0){\includegraphics[width=\unitlength]{vape_prediction.eps}}%
    ...
    \put(0.3267289,0.04247958){\color[rgb]{0.00392157,0.78431373,1}\makebox(0,0)[t]{\lineheight{0}\smash{\begin{tabular}[t]{c}$\alpha_{i-1,i}$\end{tabular}}}}%
    \put(0.67719951,0.04247911){\color[rgb]{0.00392157,0.78431373,1}\makebox(0,0)[t]{\lineheight{0}\smash{\begin{tabular}[t]{c}$\alpha_{i,i+1}$\end{tabular}}}}%
